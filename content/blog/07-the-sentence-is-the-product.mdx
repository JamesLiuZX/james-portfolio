...
date: "August 4, 2026"
description: "Most prediction market disputes are not oracle failures. They are writing failures, and they are catchable by a checklist."
...
> I built a linter for exactly this class of failure. It scores that market **3 out of 100**, and the rewrite 95. [Open the resolution linter](/demos/resolution-linter) and load the Ukraine example.
